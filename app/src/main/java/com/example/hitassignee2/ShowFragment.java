...
public class ShowFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textName = (TextView) view.findViewById(R.id.show_textName);
        TextView textdesc = (TextView) view.findViewById(R.id.show_textDescription);
        ImageView img = (ImageView) view.findViewById(R.id.show_imageView);
